...
data_dir = '/Users/m.wehrens/Data/2022_09_micetimeline/2022_11_mice37samples/counttables/'

################################################################################

library(pals)
library(patchwork)
cols_alphabet1 = pals::alphabet(26); names(cols_alphabet1)=NULL
cols_alphabet2 = pals::alphabet2(26); names(cols_alphabet2)=NULL
