...
mousetime_ids = 
    c(  flib.30='Martijn-Wehrens-sample1_AACGFYKM5_S2_L001_pT.nonRibo_E99_Aligned.out.counts.tsv' ,
        flib.18='Martijn-Wehrens-sample2_AACGFYKM5_S3_L001_pT.nonRibo_E99_Aligned.out.counts.tsv' )
